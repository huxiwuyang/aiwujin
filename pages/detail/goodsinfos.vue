<template>
    <view class="s-page-wrapper">
        <view class="index-goods" v-if="loadGoods">
            ...
            <view class="goods_info" style="padding-top: 6px">
                ...
                <view style="padding: 8px">
                    ...
                    <text style="font-weight: bold"><text v-if="goods.shopname" style="color: #FC3F78;font-weight: bold">
                        【{{goods.shopname}}】
            ...
            <view>
                <view style="font-weight: bold;background: #FFFFFF;text-align: center;padding: 16px;color: #FC3F78;font-size: 20px;">
                    <view>▼</view>
                    新人免单流程
        ...
        <!-- <view v-if="couponlist.length > 0"
              style="text-align: center;font-size: 18px;color: #FC3F78;background: white;margin-top: -60px;padding: 16px">
            为你推荐
        </view>
