<template>
	<view style="text-align: center;background: white;height: 100%;position: absolute;width: 100%">
		...
		<view @click="productHaibao()" style="margin-top:32upx;margin-left: 40px;margin-right:40px;font-size: 32upx;background: #FF6DB2;color: white;border-radius: 10px;height: 40px;line-height: 40px">
			海报推广
		</view>
		<view @click="share()" style="margin-top:32upx;margin-left: 40px;margin-right:40px;font-size: 32upx;background: #FF6DB2;color: white;border-radius: 10px;height: 40px;line-height: 40px">
			链接推广
		</view>
		<view @click="yaoqing()" style="margin-top:32upx;margin-left: 40px;margin-right:40px;font-size: 32upx;background: #FF6DB2;color: white;border-radius: 10px;height: 40px;line-height: 40px">
			邀请的好友
		</view>
