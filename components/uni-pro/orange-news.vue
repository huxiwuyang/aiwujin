...
<!--                <div style="color: #FC3F78;margin-top: 4px;margin-bottom: 4px" @click="copyHref()">#点击此处复制分享素材#</div>-->
            </view>
        </view>
        <!--图片-->
        <view style="display: flex">
            <view>
                <view v-for="(g,index) in goods" :key="index" class="box-float">
                    ...
                    <view style="font-size: 12px;position: absolute; bottom: 0; left: 0;background: #FC3F78;color: white;padding-right: 4px;padding-left: 4px">{{ g.price }}</view>
                </view>
            </view>
        </view>
