...
import hotnewsList from './components/uni-pro/hot-news-list'
import vedionewsList from './components/uni-pro/vedio-news-list'
import currentpolicticsList from './components/uni-pro/list_current_politics'
...
import broadcastCard from './components/uni-pro/broadcast-card'
...
Vue.component('hot-news-list', hotnewsList);
Vue.component('vedio-news-list', vedionewsList);
Vue.component('list-current-politics', currentpolicticsList);
Vue.component('orange-goods-news-list', orangeGoodsNewsList);
Vue.component('orange-goods-card', orangeGoodsCarg);
Vue.component('broadcast-card', broadcastCard);
